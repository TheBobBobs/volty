...
#[derive(
    Serialize, Deserialize, Debug, PartialEq, Eq, TryFromPrimitive, IntoPrimitive, Copy, Clone,
)]
#[repr(u64)]
pub enum Permission {
    // * Generic permissions
...
impl std::fmt::Display for Permission {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let s = match self {
            ...
            Permission::InviteOthers => "InviteOthers",
            Permission::SendEmbeds => "SendEmbeds",
            Permission::UploadFiles => "UploadFiles",
            Permission::Masquerade => "Masquerade",
            ...
            Permission::GrantAllSafe => "GrantAllSafe",
            Permission::GrantAll => "GrantAll",
        };
        f.write_str(s)
    }
}
...
lazy_static! {
    ...
    pub static ref DEFAULT_PERMISSION_DIRECT_MESSAGE: u64 =
        *DEFAULT_PERMISSION + Permission::ManageChannel + Permission::React;
    pub static ref DEFAULT_PERMISSION_SERVER: u64 = *DEFAULT_PERMISSION
        + Permission::React
